...
import ai.runapi.flux2.types.TextToImageResponse;
    ...
    class Flux2LocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/flux_2/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/flux_2/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/flux_2/text_to_image/task_local_123", captured.path);
