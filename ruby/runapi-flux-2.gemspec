...
Dir.chdir(__dir__) do
  ...
  Gem::Specification.new do |spec|
    ...
    spec.summary = "Flux 2 API SDKs for JavaScript, Ruby, and Go on RunAPI."
    spec.description = "RunAPI Flux 2 SDK for JavaScript, Ruby, and Go"
    spec.homepage = "https://runapi.ai/models/flux-2"
    spec.license = "Apache-2.0"
    spec.required_ruby_version = ">= 3.1.0"
    spec.metadata["homepage_uri"] = "https://runapi.ai/models/flux-2"
    spec.metadata["documentation_uri"] = "https://github.com/runapi-ai/flux-2-sdk/blob/main/README.md"
